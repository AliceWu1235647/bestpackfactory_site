...
function existsForHref(from, href) {
  ...
  // Runtime-injected links added by the Next.js layout (app/layout.js) — these are
  // produced by the build step and served from the Vercel deployment, never stored
