...
<section class="section faq-block"><h2>Frequently Asked Questions</h2>${product.faqs.map(([question, answer]) => `<details><summary>${esc(question)}</summary><p>${esc(answer)}</p></details>`).join('')}</section><section class="section alt"><h2>Related custom packaging resources</h2><p><a href="/products/custom-rigid-boxes.html">Custom rigid boxes</a> · <a href="/products/paper-bags.html">Custom paper bags</a> · <a href="/blog/custom-packaging-rfq-checklist.html">Packaging RFQ checklist</a></p><a class="btn" href="/contact.html">Send RFQ Details</a></section></main>
