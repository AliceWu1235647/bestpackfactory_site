# BestPack Factory Website 鈥?Deployment Guide
...
- Local environment variables are not automatically copied to Vercel. Add production values in **Vercel 鈫?Project 鈫?Settings 鈫?Environment Variables**.
...
3. In Vercel, select **Add New 鈫?Project** and import the GitHub repository.
...
6. Select **Deploy**.
7. Add `bestpackfactory.com` and `www.bestpackfactory.com` under **Settings 鈫?Domains** and apply the DNS records shown by Vercel.
...
Analytics: Google Analytics was intentionally removed from the site (2026-08-27). No GA script is loaded on any page.
